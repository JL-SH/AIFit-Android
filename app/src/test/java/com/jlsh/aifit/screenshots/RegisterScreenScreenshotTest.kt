...
class RegisterScreenScreenshotTest {
    ...
    @Test
    fun `RegisterScreen snapshot estado Idle dark mode`() {
        ...
        composeTestRule.onRoot().captureRoboImage(
            filePath = "src/test/screenshots/RegisterScreen_idle_dark.png",
        )
    }

    @Test
    fun `RegisterScreen snapshot estado Idle light mode`() {
        composeTestRule.setContent {
        ...
        composeTestRule.onRoot().captureRoboImage(
            filePath = "src/test/screenshots/RegisterScreen_idle_light.png",
        )
    }
}
